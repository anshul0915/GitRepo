...
set _DeploySetParametersFile=%RootPath%KYC-WEB-ADMIN.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%KYC-WEB-ADMIN.zip" (
echo "%RootPath%KYC-WEB-ADMIN.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%KYC-WEB-ADMIN.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%KYC-WEB-ADMIN.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%KYC-WEB-ADMIN.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%KYC-WEB-ADMIN.SetParameters.xml" %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%KYC-WEB-ADMIN.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%KYC-WEB-ADMIN.SetParameters.xml" %_MsDeployAdditionalFlags%
)
goto :eof
...
:usage
echo =========================================================
if not exist "%RootPath%KYC-WEB-ADMIN.deploy-readme.txt" (
...
start notepad "%RootPath%KYC-WEB-ADMIN.deploy-readme.txt"
)
echo =========================================================
goto :eof
